...
CREATE TABLE "Pruducts" (
    ...
    CONSTRAINT "Pruducts_pkey" PRIMARY KEY ("productId")
);
...
-- AddForeignKey
ALTER TABLE "Sales" ADD CONSTRAINT "Sales_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Pruducts"("productId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Purchases" ADD CONSTRAINT "Purchases_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Pruducts"("productId") ON DELETE RESTRICT ON UPDATE CASCADE;
